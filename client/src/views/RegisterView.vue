    ...
    <form v-on:submit.prevent="register">
      ...
      <div id="fields">
        ...
        <div class="inp-container">
          <label class="usnLabel" for="username">Username</label>
          <input
            type="text"
            id="username"
        ...
        <div class="inp-container">
          <label class="nmLabel" for="name">Name</label>
          <input
            type="text"
            id="name"
            placeholder="Name"
        ...
        <div class="inp-container">
          <label class="cofpwdLabel" for="confirmPassword">Confirm password</label>
          <input
            type="password"
            id="confirmPassword"
        ...
        <div class="inp-container">
          <label class="adrLabel" for="address">Address</label>
          <input
            type="text"
            id="address"
            placeholder="Address"
        ...
        <div class="inp-container">
          <label class="citLabel" for="city">City</label>
          <input type="text" id="city" placeholder="City" v-model="user.city" />
        </div>

        <div class="inp-container">
          <label class="stLabel" for="state">State</label>
          <input
            type="text"
            id="state"
            placeholder="State"
